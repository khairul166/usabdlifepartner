...
if (class_exists('CSF')) {
  ...
  CSF::createOptions('mytheme_options', [
      'menu_title'      => 'Theme Options',
      'menu_slug'       => 'mytheme-options',
      'framework_title' => 'MyTheme Options',
  ]);

  CSF::createSection('mytheme_options', [
      'title'  => 'Teams',
      'fields' => [
          [
              'id'      => 'team_members',
              ...
              'fields'  => [
                  ...
                  [ 'id' => 'designation', 'type' => 'text', 'title' => 'Designation' ],
                  [ 'id' => 'qualification', 'type' => 'text', 'title' => 'Qualification' ],
                  [ 'id' => 'experience', 'type' => 'text', 'title' => 'Experience' ],
                  [ 'id' => 'about', 'type' => 'textarea', 'title' => 'About' ],
                  [ 'id' => 'image', 'type' => 'media', 'title' => 'Profile Image' ],
                  [ 'id' => 'facebook', 'type' => 'text', 'title' => 'Facebook' ],
                  [ 'id' => 'twitter', 'type' => 'text', 'title' => 'Twitter' ],
                  [ 'id' => 'linkedin', 'type' => 'text', 'title' => 'LinkedIn' ],
                  [ 'id' => 'instagram', 'type' => 'text', 'title' => 'Instagram' ],
                  [ 'id' => 'youtube', 'type' => 'text', 'title' => 'YouTube' ],
              ],
          ],
      ],
  ]);
